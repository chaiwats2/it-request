...
<br><br><br>
      ...
      ?>
      <td style="font-size:20px"><strong>ตารางคำขอที่ปิดงานแล้ว</strong></td>
      ...
      <table width="1200px" class="imagetable" align="center" border="1px">
        ...
        <?php
        $sql="select*from tbrequest where status='completed'";
        ...
        <td align="center">
            <a href="frmresponse.php?idA=<?php echo $reqid; ?>"><button><i class="flaticon-file87"></i></button></a>
        </td>
        </tr>
         <?php } ?>
     </table>
    <table class="imagetable" width="1200" align="center">
    <th align="left">คุณปิดงานไปแล้ว <?php echo $i; ?> รายการ</th>
    <th align="right">
