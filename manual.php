      ...
      <div class="navbar-inner">
        <div class="container-fluid">
          ...
          <div class="nav-collapse collapse">
            ...
            <ul class="nav">
              <li class="active"><a href="#" class="flaticon-book202">  Manual</a></li>
            </ul>
          </div><!--/.nav-collapse -->
        </div>
      </div>
        ...
        <div class="span3">
          <div class="well sidebar-nav">
            <ul class="nav nav-list">
              ...
              <li class="active"><a href="#">Link<i align="right" style="float: right;" class="icon1-chevron-right"></i></a></li>
              <li><a href="#">Link<i align="right" style="float: right;" class="icon1-chevron-right"></i></a></li>
              <li><a href="#">Link<i align="right" style="float: right;" class="icon1-chevron-right"></i></a></li>
              <li><a href="#">Link<i align="right" style="float: right;" class="icon1-chevron-right"></i></a></li>
            </ul>
          </div><!--/.well -->
